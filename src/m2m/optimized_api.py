...
from . import SimpleVectorDB, AdvancedVectorDB, M2MConfig
from .gpu_auto_tune import get_gpu_tuner, GPUAutoTuner
from .query_optimizer import QueryOptimizer
from .auto_scaling import AutoScaler, NodeMetrics, HorizontalScaler
...
class M2MOptimized:
    ...
    def __init__(self,
        ...
        if enable_autoscale:
            ...
            self.cluster = HorizontalScaler(node_template={
                'cpu': 4,
                'memory': '8GB',
                'latent_dim': latent_dim
            })
            ...
            self.scaler.register_callbacks(
                scale_up=self.cluster.scale_up,
                scale_down=self.cluster.scale_down
            )
