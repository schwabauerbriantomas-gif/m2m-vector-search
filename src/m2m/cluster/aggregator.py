...
class ResultAggregator:
    ...
    def _rrf_merge(self, results: Dict[str, List[Tuple[int, float]]], k: int) -> List[Tuple[int, float]]:
        """
    ...
    def _score_merge(self, results: Dict[str, List[Tuple[int, float]]], k: int) -> List[Tuple[int, float]]:
        """
